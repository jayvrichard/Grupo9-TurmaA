...
//================================================================ CAPITULO 3 ==============================================================================================================================
	static void capitulo_3() throws Exception {
		...
		do {
	    Digita("\n\n - " + nome_aventureiro + " 1} Você foi covarde matando meu pai enquanto ele estava fraco! 2} Você vai pagar por tudo que fez cretino!", TimeUnit.MILLISECONDS, temp_dialog);
...
int resp15;
		...
		do {
			Digita("\n\n - " + nome_aventureiro + " 1} Você falou com ela? 2} Está pronto? ", TimeUnit.MILLISECONDS, temp_dialog);
		...
		Digita("\n\n  Grannus: Eu contei a ela o que fiz, somente o que ela precisava saber… estou pronto!!",  TimeUnit.MILLISECONDS, temp_dialog);
		
int resp16;
		
		do {
			Digita("\n\n - " + nome_aventureiro + " 1} Tem alguma coisa que posso fazer por você? 2} Você pensou em como vai fazer isso? ", TimeUnit.MILLISECONDS, temp_dialog);
			
			System.out.println("\n");
			resp16 = entrada.nextInt();
			
			if(resp16 == 1) {
				Digita("\n\n - " + nome_aventureiro + " Tem alguma coisa que posso fazer por você? ", TimeUnit.MILLISECONDS, temp_dialog);
				Digita("\n\n  Grannus: Não meu jovem, eu cuidarei do resto! Obrigado por me trazerem de volta para casa!",  TimeUnit.MILLISECONDS, temp_dialog);
				break;
			}else if(resp16 == 2) {
				Digita("\n\n - " + nome_aventureiro + " Você pensou em como vai fazer isso? ", TimeUnit.MILLISECONDS, temp_dialog);
				Digita("\n\n  Grannus: Acho que sei como fazer mas preciso da ajuda do Doodou.",  TimeUnit.MILLISECONDS, temp_dialog);
				break;
			}else {
				System.out.println("Você não digitou uma resposta valída!");
			}
		...
		Digita("\n\n  Grannus: Vamos para fora e se não se importarem peço que enterrem o meu corpo ao lado de meu mestre, não quero que lembrem de mim pelas coisas ruins que fiz!!",  TimeUnit.MILLISECONDS, temp_dialog);
		Digita("\n\n  Doodou: Eu sei de uma poção que fará isso sem dor, posso começar?",  TimeUnit.MILLISECONDS, temp_dialog);
		
int resp17;
		
		do {
			Digita("\n\n - " + nome_aventureiro + " 1} Você foi um grande herói Grannus, sempre lembraremos disso! 2} Meu pai espera por você! Adeus! ", TimeUnit.MILLISECONDS, temp_dialog);
			
			System.out.println("\n");
			resp17 = entrada.nextInt();
			
			if(resp17 == 1) {
				Digita("\n\n - " + nome_aventureiro + " Você foi um grande herói Grannus, sempre lembraremos disso!! ", TimeUnit.MILLISECONDS, temp_dialog);
				break;
			}else if(resp17 == 2) {
				Digita("\n\n - " + nome_aventureiro + " Meu pai espera por você! Adeus!! ", TimeUnit.MILLISECONDS, temp_dialog);
				break;
			}else {
				System.out.println("Você não digitou uma resposta valída!");
			}
		...
		Digita("\n\n  A ira de Grannus era tão grande por ter feito tanta maldade a família que mais amava, que usou uma de suas magias mais poderosas contra ele mesmo, desintegrando sua alma por completo dando seu último suspiro.",  TimeUnit.MILLISECONDS, temp_dialog);
		Digita("\n\n  O ato de sacrifício de Grannus fez a maldição de Bryanna desaparecer e restaurar as forças da jovem, tornando-a uma poderosa feiticeira.",  TimeUnit.MILLISECONDS, temp_dialog);
