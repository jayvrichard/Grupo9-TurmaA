		...
		do {
			...
			do {
				...
				Digita("\n\n - Doodou: Ei para de gritar podemos morrer sabia!?", 
						TimeUnit.MILLISECONDS, temp_transicao);
				Digita("\n\n - Enganador: Vocês realmente não sabem onde se meteram, não é mesmo?" + " Bem-vindos a minha casa, se acomodam, pois, vocês jamais sairão daqui! HAHAHAHAHAHAHAHA!!", 
						TimeUnit.MILLISECONDS, temp_transicao);
				...
				do {
					...
					do {
						...
						do {
							...
							Digita("\n\n - Enganador: Muito bem Jogador, você parece estar determinado por uma boa causa." + " Vou te ajudá-lo mais uma vez, leve minha espada, ela foi forjada por anões nas Montanhas de Elso, feita de titânio encontrado naquela montanha.", 
									TimeUnit.MILLISECONDS, temp_transicao);
...
//================================================================ CAPITULO 3 ==============================================================================================================================
	static void capitulo_3(int numTentativas1) throws Exception {
		...
		Digita("\n\n  Grannus: AAAAAAH, AHHHH TIRA ISSO DE MIM JOGADOR! EU NÃO AGUENTO MAIS!!!!!",
				TimeUnit.MILLISECONDS, temp_dialog);
